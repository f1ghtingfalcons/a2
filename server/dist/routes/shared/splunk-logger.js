...
var splunk = require("splunk-logging");
...
var Logger = (function () {
    function Logger() {
         ...
         */
        this.splunkWriter = new stream_1.Writable({
        ...
        if (process.env.deploy_type === 'production') {
            splunkConfig = {
                token: config_1.prodSplunkHEC,
                url: 'https://dmz-web-00.pdmz.lasp.colorado.edu:8088'
            };
        }
        else {
            splunkConfig = {
                token: config_1.devSplunkHEC,
                url: 'https://dmz-web-00.pdmz.lasp.colorado.edu:8088'
            };
        }
     ...
     */
    Logger.prototype.warn = function (req, message) {
     ...
     */
    Logger.prototype.info = function (req, message) {
        message.operator = this.getOperator(req);
     ...
     * @param {Request} req - The incoming http request
     */
    Logger.prototype.getOperator = function (req) {
...
//# sourceMappingURL=splunk-logger.js.map
